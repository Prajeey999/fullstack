...
const HomePage = () => {
  ...
  <section className="hero">
    ...
    <div className="btn-group">
      <Link to='/giftvibes/user/products' style={{textDecoration:'none'}}><button className="btn-filled-dark">
  ...
  <section>
    ...
    <ul className="shop-pets">
      <li className="card-large card-light" id="sup-dog">
        ...
        <ul>
          Gifts for Him
          <h6 className='thecarddis'>The best gift for Boys</h6>
      ...
      <li className="card-large card-dark" id="sup-cat">
        ...
        <ul>
          Gifts for Her
          <h6 className='thecarddis'>The best gift for Girls</h6>
